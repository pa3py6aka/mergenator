let Mergenator = (function () {
    const MAX_RECONNECT_ATTEMPTS = 50,
          INITIAL_RECONNECT_DELAY = 1000,
          DEBUG = false,
          logContainer = document.getElementById('output'),
    ...
    const mWSocket = {
        connectWebSocket: function () {
            ...
            socket.onclose = function(event) {
                let reason = mWSocket.getCloseReason(event);
                ...
                mWSocket.scheduleReconnect();
            };
        },
        getCloseReason: function (event) {
            switch (event.code) {
